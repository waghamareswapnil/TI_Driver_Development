...
%.o: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"D:/Swapnil_Software/Code_Composer_Studio_TI/ccs/tools/compiler/ti-cgt-armllvm_3.2.2.LTS/bin/tiarmclang.exe" -c @"device.opt"  -march=thumbv6m -mcpu=cortex-m0plus -mfloat-abi=soft -mlittle-endian -mthumb -O2 -I"C:/Users/sacf n/Desktop/Git_Practice/TI_Timer_Driver_Prictice/TI_Driver_Development" -I"C:/Users/sacf n/Desktop/Git_Practice/TI_Timer_Driver_Prictice/TI_Driver_Development/Debug" -I"C:/ti/mspm0_sdk_2_10_00_04/source/third_party/CMSIS/Core/Include" -I"C:/ti/mspm0_sdk_2_10_00_04/source" -gdwarf-3 -Wall -MMD -MP -MF"$(basename $(<F)).d_raw" -MT"$(@)"  $(GEN_OPTS__FLAG) -o"$@" "$<"
...
build-81021297: ../empty.syscfg
	...
	"C:/ti/sysconfig_1.26.2/sysconfig_cli.bat" --script "C:/Users/sacf n/Desktop/Git_Practice/TI_Timer_Driver_Prictice/TI_Driver_Development/empty.syscfg" -o "." -s "C:/ti/mspm0_sdk_2_10_00_04/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '
